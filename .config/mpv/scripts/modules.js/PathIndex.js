...
PathIndex.prototype._readdir = function (path, type) {
  if (typeof path !== "string") throw "_readdir: No path provided";
...
PathIndex.prototype.update = function (newPath, newSettings) {
  ...
  if (typeof newPath === "string") this.path = newPath;
  if (typeof newSettings !== "undefined") this.changeSettings(newSettings);
